...
class MainMenu:
    ...
    def __init__(self, windowWidth, windowHeight):
        ...
        self.title = self.font.render("KSP(OS)", True, (0, 0, 0))
        self.buttons = [
            {"text": "The Shop", "action": "shop", "rect": None},
            {"text": "Air Mission", "action": "air", "rect": None},
            {"text": "Space Mission", "action": "space", "rect": None},
        ]
        self.showHelp = False
    ...
    def render(self, surface, geometrySet, geometry=None):
        ...
        for button in self.buttons:
            if button["action"] in self.AVAILABLE_ENVIRONMENTS and not geometrySet:
